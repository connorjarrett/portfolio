const images = [
    ...
    {
        path: "media/gallery/bigben.webp",
    ...
    {
        path: "media/gallery/cablecar.webp",
    ...
    {
        path: "media/gallery/golden_gate_bridge.webp",
    ...
    {
        path: "media/gallery/picadilly.webp",
    ...
    {
        path: "media/gallery/salesforce.webp",
    ...
    {
        path: "media/gallery/southbank_place.webp",
    ...
    {
        path: "media/gallery/181freemont.webp",
    ...
    {
        path: "media/gallery/560mission.webp",
    ...
    {
        path: "media/gallery/goldengate2.webp",
    ...
    {
        path: "media/gallery/onecassonsq.webp",
    ...
    {
        path: "media/gallery/time_square_day.jpeg",
    ...
    {
        path: "media/gallery/highline.jpeg",
    ...
    {
        path: "media/gallery/nycskyline.jpeg",
    ...
    {
        path: "media/gallery/bryantpark.jpeg",
    ...
    {
        path: "media/gallery/towerfountain.jpeg",
    ...
    {
        path: "media/gallery/belvedere_castle.jpeg",
    ...
    {
        path: "media/gallery/brooklyn_bridge_crossing.jpeg",
    ...
    {
        path: "media/gallery/subway.jpeg",
    ...
    {
        path: "media/gallery/70_vestry.jpeg",
    ...
    {
        path: "media/gallery/brooklyn_bridge_below.jpeg",
    ...
    {
        path: "media/gallery/wallst.jpeg",
    ...
    {
        path: "media/gallery/reservoir.jpeg",
    ...
    {
        path: "media/gallery/time_square_night.jpeg",
    ...
    {
        path: "media/gallery/battersea.jpeg",
    ...
    {
        path: "media/gallery/one_bank_st.jpeg",
    ...
    {
        path: "media/gallery/lis_street.jpeg",
